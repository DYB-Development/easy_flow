...
- **Blank answer** — a step the visitor leaves blank records nothing. The visitor is shown the same step again with a message telling them to answer it, whether the flow keeps a stored run or carries its answers in the page.
